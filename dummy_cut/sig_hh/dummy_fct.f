      ...
      real, dimension(0:3) :: h1
      real, dimension(0:3) :: h2
      real :: pxh1, pyh1, pxh1, pyh1, Pth1, Pth2
      ...
      Pth1 = sqrt(pxh1**2 + pyh1**2)
      Pth2 = sqrt(pxh2**2 + pyh2**2)
      dummy_cuts = Pth1 > 400.0 .and. Pth1 < 1200.0 .and. Pth2 > 400.0 .and. Pth2 < 1200.0
